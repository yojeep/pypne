...
// 		   _s(nPoints) + "\" NumberOfCells = \"" + _s(nCells) + "\" >\n";
// }
...
// 	dbl3 c1(elem.mb22()->fx, elem.mb22()->fy, elem.mb22()->fz);
// 	dbl3 c2(elemp.mb->fx, elemp.mb->fy, elemp.mb->fz);
...
// 	{
// 		radius.push_back(vi.R);
// 		pointTyps.push_back(vi.type);
// 	}
// 	cellPoints.push_back(findOrInsert(points, c2));
// 	if (radius.size() < points.size())
// 	{
// 		radius.push_back(vj->R);
// 		pointTyps.push_back(vj->type);
// 	}
...
// 		if (tr.e2 != VElems(mvi->fi + 1, mvi->fj + 1, mvi->fk + 1))
// 			++Dkfhj1;
// 		if (mb2->boss == mb2)
// 			++E_msfd;
...
// 		{
// 			mvi = mb1->mastrSphere();
// 			if (tr.e1 != VElems(mvi->fi + 1, mvi->fj + 1, mvi->fk + 1))
// 				++Dkfhj2;
