...
// template <typename T> float sq(T x) { return x * x; }
...
// binary_edtsq(T *labels, const int sx, const int sy, const int sz,
//              const float wx, const float wy, const float wz,
//              const bool black_border = false, float *output = NULL) {

//   return _binary_edt3dsq(labels, sx, sy, sz, wx, wy, wz, black_border, output);
// }
// } // namespace edt