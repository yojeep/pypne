...
//   std::cout << " write_radius   " << std::endl;
...
//       maxr = std::max(maxr, vi.R);
//       minr = std::min(minr, vi.R);
//     }
//     std::cout << "  radius  [" << minr << "  " << maxr
//               << "]   nVs:" << rf.vxlSpace.size() << std::endl;
//   }
//   return vfild;
// }
...
//   std::cout << " write_throats   " << std::endl;
...
// voxelField<int> VThroats(const blockNetwork &mpn, int beginSlice,
//                          int endSlice) {
//   std::cout << " write_throats   " << std::endl;
//   int x, y, zdummy;
...
//   std::cout << " write_poreMaxBalls   " << std::endl;
//   voxelField<int> vfild(mpn.cg.nx, mpn.cg.ny, mpn.cg.nz, 0);

//   const medialSurface &rf = *mpn.srf;

//   for (const medialBall &vi : rf.ballSpace)
//     if (vi.level() == 1) {
...
// voxelField<int> poreMaxBalls(const blockNetwork &mpn, int firstSlice,
//                              int lastSlice) {
//   std::cout << " write_poreMaxBalls   " << std::endl;
...
//   std::cout << " write_throatMaxBalls   " << std::endl;
//   voxelField<int> vfild(mpn.cg.nx, mpn.cg.ny, mpn.cg.nz, 0);
...
// voxelField<int> throatMaxBalls(const blockNetwork &mpn, int firstSlice,
//                                int lastSlice) {
//   std::cout << " write_throatMaxBalls   " << std::endl;
//   voxelField<int> vfild(mpn.cg.nx, mpn.cg.ny, lastSlice - firstSlice, 0);
//   const medialSurface &rf = *mpn.srf;
