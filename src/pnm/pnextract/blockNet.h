...
#define _frmtd_(_d_m, _p_m, _w_m)                                              \
  setw(_w_m) << (1. / _p_m) * round((_d_m) * _p_m)
#define _frmtd3_(_d_m, _p_m, _w_m)                                             \
  _frmtd_((_d_m)._0(), _p_m, _w_m) << " " << _frmtd_((_d_m)._1(), _p_m, _w_m)  \
                                   << " " << _frmtd_((_d_m)._2(), _p_m, _w_m)
